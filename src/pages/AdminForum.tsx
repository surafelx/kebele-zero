...
const AdminForum = () => {
  ...
  const totalViews = forumPosts.reduce((sum, p) => sum + (p.views || 0), 0);
  const totalLikes = forumPosts.reduce((sum, p) => sum + (p.likes || 0), 0);
  const thisWeekPosts = forumPosts.filter(p => new Date(p.created_at) > new Date(Date.now() - 7 * 24 * 60 * 60 * 1000)).length;

  return (
    <div className="space-y-6">
      {/* Header - Retro Style */}
      <div className="bg-white border-4 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
        <div className="flex items-center justify-between px-4 py-3 bg-gradient-to-r from-sky-500 to-blue-600">
          <div className="flex items-center space-x-3">
            <div className="w-10 h-10 bg-white border-2 border-black flex items-center justify-center">
              <MessageSquare className="w-5 h-5 text-black" />
            </div>
            <div>
              <h2 className="text-xl font-black text-white uppercase tracking-wide">Forum Management</h2>
              <p className="text-xs text-white/80 uppercase tracking-wide">Manage forum posts and community discussions</p>
            </div>
          </div>
          <button
      ...
      <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
        <div className="bg-white border-4 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
          <div className="flex items-center justify-between p-4">
            <div>
              <p className="retro-text text-xs uppercase tracking-wide">Total Posts</p>
              <p className="text-2xl retro-title">{forumPosts.length}</p>
            </div>
            <div className="w-10 h-10 bg-white border-2 border-black flex items-center justify-center">
              <MessageSquare className="w-5 h-5 text-black" />
            </div>
        ...
        <div className="bg-white border-4 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
          <div className="flex items-center justify-between p-4">
            <div>
              <p className="retro-text text-xs uppercase tracking-wide">This Week</p>
              <p className="text-2xl retro-title">{thisWeekPosts}</p>
            </div>
            <div className="w-10 h-10 bg-white border-2 border-black flex items-center justify-center">
        ...
        <div className="bg-white border-4 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
          <div className="flex items-center justify-between p-4">
            <div>
              <p className="retro-text text-xs uppercase tracking-wide">Comments</p>
              <p className="text-2xl retro-title">{forumComments.length}</p>
            </div>
            <div className="w-10 h-10 bg-white border-2 border-black flex items-center justify-center">
        ...
        <div className="bg-white border-4 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
          <div className="flex items-center justify-between p-4">
            <div>
              <p className="retro-text text-xs uppercase tracking-wide">Total Views</p>
              <p className="text-2xl retro-title">{totalViews}</p>
            </div>
            <div className="w-10 h-10 bg-white border-2 border-black flex items-center justify-center">
        ...
        <div className="bg-white border-4 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
          <div className="flex items-center justify-between p-4">
            <div>
              <p className="retro-text text-xs uppercase tracking-wide">Total Likes</p>
              <p className="text-2xl retro-title">{totalLikes}</p>
            </div>
            <div className="w-10 h-10 bg-white border-2 border-black flex items-center justify-center">
      ...
      {/* Posts List */}
      {loading ? (
        <div className="bg-white border-4 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] text-center py-16">
          <div className="w-16 h-16 border-4 border-blue-200 border-t-blue-500 rounded-full animate-spin mx-auto mb-6"></div>
          <p className="retro-text">Loading forum posts...</p>
        </div>
      ) : forumPosts.length === 0 ? (
        <div className="bg-white border-4 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] p-12 text-center">
          ...
          <p className="retro-text text-sm mt-1 opacity-70">Create the first post to get started</p>
        </div>
      ) : (
        <div className="space-y-6">
          {(() => {
              ...
              <>
                <div className="space-y-4">
                  {paginatedPosts.map((post) => (
                    <div key={post.id} className="bg-white border-4 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] p-4 hover:shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] transition-all">
