...
export class FloorMaterial extends ShaderMaterial {
  ...
  private updateUniforms() {
    const data = new Uint8Array([
      Math.round(this._bottomLeftColor.r * 250),
      Math.round(this._bottomLeftColor.g * 250),
      Math.round(this._bottomLeftColor.b * 250),
      255,
      Math.round(this._bottomRightColor.r * 250),
      Math.round(this._bottomRightColor.g * 250),
      Math.round(this._bottomRightColor.b * 250),
      255,
      Math.round(this._topLeftColor.r * 250),
      Math.round(this._topLeftColor.g * 250),
      Math.round(this._topLeftColor.b * 250),
      255,
      Math.round(this._topRightColor.r * 250),
      Math.round(this._topRightColor.g * 250),
      Math.round(this._topRightColor.b * 250),
      255,
    ]);
