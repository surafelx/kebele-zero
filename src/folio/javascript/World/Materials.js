...
export default class Materials
{
    ...
    setShades()
    {
        ...
        this.items.green = this.shades.items.green
         ...
         // Green
        this.shades.items.green = new MatcapMaterial()
        this.shades.items.green.name = 'shadeGreen2'
        this.shades.items.green.uniforms.matcap.value = this.resources.items.matcapGreenTexture
        this.items.green = this.shades.items.green
        ...
        // // Cyan
        this.shades.items.cyan = new MatcapMaterial()
        this.shades.items.cyan.name = 'shadeCyan'
        this.shades.items.cyan.uniforms.matcap.value = this.resources.items.matcapCyanTexture
        this.items.cyan = this.shades.items.cyan


       // // Purple2
        this.shades.items.purple2 = new MatcapMaterial()
        this.shades.items.purple2.name = 'shadePurple2'
        this.shades.items.purple2.uniforms.matcap.value = this.resources.items.matcapPurple2Texture
        this.items.purple2 = this.shades.items.purple2

        // Green2
        this.shades.items.green2 = new MatcapMaterial()
        this.shades.items.green2.name = 'shadeTree'
        this.shades.items.green2.uniforms.matcap.value = this.resources.items.matcapGreen2Texture
        this.items.green2 = this.shades.items.green2

        // Green3 
       this.shades.items.green3 = new MatcapMaterial()
        this.shades.items.green3.name = 'shadeGreenThree'
        this.shades.items.green3.uniforms.matcap.value = this.resources.items.matcapGreen3Texture
        this.items.green3 = this.shades.items.green3
