...
export default class Resources extends EventEmitter
{
    constructor()
    {
        ...
        this.loader.load([
            ...
            { name: 'matcapCyan', source: matcapCyanSource, type: 'texture' },
 { name: 'matcapPurple2', source: matcapPurple2Source, type: 'texture' },
  { name: 'matcapGreen2', source: matcapGreen2Source, type: 'texture' },
    { name: 'matcapGreen3', source: matcapGreen3Source, type: 'texture' },
